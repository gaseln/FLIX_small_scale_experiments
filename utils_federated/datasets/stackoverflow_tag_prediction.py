...
def get_federated_datasets(
  ...
  """Loads federated Stack Overflow tag prediction datasets.
  ...
  (stackoverflow_train, _,
   stackoverflow_test) = tff.simulation.datasets.stackoverflow.load_data(cache_dir='/home/gasanoe/Documents/fed_mixture_code/datasets')
